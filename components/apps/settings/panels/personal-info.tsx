...
interface Device {
  name: string;
  model: string;
  type: "macbook" | "iphone" | "ipad" | "homepod-mini";
}

const devices: Device[] = [
  { name: "James's MacBook Pro", model: "This MacBook Pro", type: "macbook" },
  { name: "James's iPhone 15 Pro", model: "iPhone 15 Pro", type: "iphone" },
  { name: "James's iPad Pro", model: "iPad Pro", type: "ipad" },
  { name: "James's HomePod mini", model: "HomePod mini", type: "homepod-mini" },
];
    ...
    case "homepod-mini":
      return (
        <div className="w-12 h-12 flex items-center justify-center">
          <img src="/homepod-mini.png" alt="HomePod mini" className="w-9 h-9 object-contain" />
        </div>
      );
  }
}
    ...
    <div className="max-w-2xl mx-auto py-4 px-4 space-y-6">
      ...
      <div className="rounded-xl bg-muted/50 overflow-hidden">
        <div className="divide-y divide-border/50">
          <a
            href="https://x.com/james_mcfadden"
            target="_blank"
          ...
          >
            ...
            <div className="flex items-center gap-1 text-muted-foreground">
              <span className="text-xs">James McFadden</span>
              <ChevronRight className="w-4 h-4" />
            </div>
          </a>
          <div className="flex items-center justify-between px-4 py-3">
            <span className="text-xs">Birthday</span>
            <span className="text-xs text-muted-foreground">3/28/2003</span>
          </div>
        </div>
      </div>
