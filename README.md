# [JMcFadden.com](https://JMcFadden.com)

This is a macos-inspired personal website featuring a full desktop environment with multiple apps.
...
`git clone https://github.com/JMcFadden/JMcFadden`
...
4. paste the sql from the [migration file](https://github.com/JMcFadden/JMcFadden/blob/main/supabase/migrations/20240710180237_initial.sql) into the sql editor and press run
...
licensed under the [mit license](https://github.com/JMcFadden/JMcFadden/blob/main/LICENSE.md).
