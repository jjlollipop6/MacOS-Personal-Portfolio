        ...
        <div className="rounded-xl bg-background overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 border-b border-border/50">
            ...
            <div className="flex items-center gap-1">
              <span className="text-base text-muted-foreground">james&apos;s iphone</span>
  ...
  return (
    <div className="max-w-lg mx-auto py-6 px-4">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-xs text-muted-foreground">M5, 2026</p>
      </div>
      ...
      <div className="rounded-xl bg-muted/50 overflow-hidden mb-6">
        <div className="divide-y divide-border/50">
          <div className="flex justify-between px-4 py-3">
            ...
            <span className="text-xs">James&apos;s MacBook Pro</span>
          </div>
          <div className="flex justify-between px-4 py-3">
            <span className="text-xs text-muted-foreground">Chip</span>
            <span className="text-xs">Apple M5</span>
          </div>
          <div className="flex justify-between px-4 py-3">
