...
const USERNAME = HOME_DIR.split("/").pop() ?? "jmcfadden";
...
const TRASH_FILES: FileItem[] = [
  { name: "resume-draft-v3.pdf", type: "file", path: "trash/resume-draft-v3.pdf" },
  { name: "kicks-byjj-inventory-2022.xlsx", type: "file", path: "trash/kicks-byjj-inventory-2022.xlsx" },
  { name: "navigator-old-prototype", type: "dir", path: "trash/navigator-old-prototype" },
  { name: "boa-internship-rejection.eml", type: "file", path: "trash/boa-internship-rejection.eml" },
  { name: "oakmont-emporium-Q4-report.pdf", type: "file", path: "trash/oakmont-emporium-Q4-report.pdf" },
  { name: "polymind-v1-deprecated", type: "dir", path: "trash/polymind-v1-deprecated" },
];
