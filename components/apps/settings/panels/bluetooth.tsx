...
const myDevicesDesktop: BluetoothDevice[] = [
  { name: "James's Magic Keyboard", connected: true, battery: 91, type: "keyboard" },
  { name: "James's AirPods Max", connected: false, type: "airpods-max" },
  { name: "James's AirPods Pro", connected: false, type: "airpods" },
];

const myDevicesMobile = [
  { name: "James's AirPods Max", connected: false },
  { name: "James's AirPods Pro", connected: false },
    ...
    return (
      <div className="px-4 py-4 space-y-4">
        ...
        <p className="text-sm text-muted-foreground px-2">
          This iPhone is discoverable as &quot;james&apos;s iphone&quot; while Bluetooth Settings is open.
        </p>
      ...
      {bluetoothEnabled && (
        <>
          ...
          <p className="text-xs text-muted-foreground py-4 border-b border-border/50">
            This Mac is discoverable as &quot;James&apos;s MacBook Pro&quot; while Bluetooth Settings is open.
          </p>
